Scheme
{
	...
	Colors
	{
		...
		"G_Highlight"			"30 215 96 255" // Highlight color
		"G_White"				"255 255 255 255"
		"G_Black"				"0 0 0 255"
		"G_Red"					"230 0 0 255"
		"G_Shadow"				"24 24 24 255" // Shadow color
		"G_LightShadow"			"0 0 0 110"
		"G_Heal"				"8 226 251 255" // Heal color
		"G_Hit"					"209 215 30 255" // Hit color
		...
		"G_TransparentMenuBG"	"40 40 40 204" // Transparent menu color
		"G_PanelBg"				"40 40 40 204" // Panel color
		"G_OpaquePanelBg"		"40 40 40 255" // Opaque Panel color
		"G_Warning"				"143 38 0 255" // Warning color
		"G_HealthValue"			"30 215 96 255" // Health value color
		"G_Overheal"			"70 136 217 255" // Overhealed health value color
		"G_LowHealthValue"		"255 255 255 255" // Low health value color
		"G_AmmoClipValue"		"27 70 216 255" // Ammo in clip value color
		"G_AmmoReserveValue"	"8 226 251 255" // Ammo in reserve value color
		"G_LowAmmo"				"222 38 34 255" // Low ammo color
		"G_MetalValue"			"235 235 235 255" // Metal color
		"G_MetalIcon"			"235 235 235 255" // Metal icon color
		"G_HeadsValue"			"235 235 235 255" // Heads value color
		"G_HeadsLabel"			"8 226 251 255" // Heads value icon color
		"G_KillstreakValue"		"255 219 80 255" // Killstreak value color
		"G_KillstreakIcon"		"255 219 80 255" // Killstreak icon color
		"G_StickyColor"					"235 235 235 255" // Stickybomb color
		"G_StickyIconColor"				"8 226 251 255" // Stickybomb icon color
		"G_CustomTargetID" 				"0 0 0 99" // Custom target id bg color
		"G_CustomBuildingStatusBg" 		"0 0 0 100" // Custom building status bg color
		"G_TargetHealthValue" 			"233 231 229 255" // Target ID health value color
		"G_TargetHealthValueShadow" 	"0 0 0 191" // Target ID health value shadow color
		"G_Killfeed_Base"			"0 0 0 89" // Killfeed Base color
		"G_Killfeed_Local"			"255 255 255 89" // Killfeed Local color
		"G_CenteredMetalBg"			"60 60 60 0" // Centered metal background color
		"G_CenteredUberchargeBg"	 "60 60 60 0" // Centered ubercharge meter background color
		...
		"G_Footer"					"24 24 24 255" // Menu footer color
		"G_DimmFooter"				"28 23 19 200" // Dimm Menu footer color
		"G_FooterText"				"160 160 160 255" // Footer text color
		"G_DimmFooterText"			"160 160 160 120" // Dimm Footer text color
		"G_OuterBorder"				"24 24 24 255" // Outer border color
		"G_InnerBorder"				"40 40 40 255" // Inner border color
		"G_KillfeedBlue"			"48 142 255 255" // Killfeed blue text
		"G_KillfeedRed"				"222 38 34 255" // Killfeed red text
		"G_KillfeedIcon"			"170 255 200 255" // Killfeed icon color
		"G_CustomHealthValue"		"120 120 120 255"
		"G_MainMenuOverlay"			"40 40 40 204" // Main Menu overlay color
		"G_MainMenuPanel"			"28 23 19 255" // Main Menu panel color
		"G_MainMenuButton"			"17 17 17 255" // Main Menu button color
		"G_MainMenuButtonHover"		"30 215 96 255" // Main Menu hovered button color
		"G_MainMenuButtonFg"		"30 215 96 255" // Main Menu button text color
		...
		"G_BackpackItemBg"			"80 80 80 255" // Backpack item bg color
		"G_LoadoutItemBg"			"40 40 40 255" // Loadout item bg color
		"G_MenuBg"					"40 40 40 255" // Menu bg color
		"G_MenuText"				"243 243 243 255" // Menu text color
		"G_InputText"				"40 40 40 255" // Input text color
		"G_DimmInputText"			"40 40 40 100" // Dimm Input text color
		"G_DimmMenuText"			"243 243 243 120" // Dimm Menu text color
		"G_ItemDescriptionPanelBg"	"24 24 24 255" // Item description panel bg
		"G_ButtonBg"				"40 40 40 255" // Button bg color
		"G_ButtonText"				"243 243 243 255" // Button text color
		"G_ButtonHoverBg"			"0 0 0 255" // Button hover bg color
		"G_ButtonHoverText"			"30 215 96 255" // Button hover text color
		"G_ButtonSelectedBg"		"30 215 96 255" // Button selected bg color
		"G_ButtonSelectedText"		"24 24 24 255" // Button selected text color
		...
		"G_ItemMeterBg"				"0 0 0 120" // Item meter bg
		"G_ItemMeterBorder"			"40 40 40 255" // Item meter border color
		"G_MenuShader"				"64 64 64 255" // Menu shader color
		...
		"G_Crosshair3Color"		"222 38 34 255" // Crosshair3 color
		...
		"TFOrange"			"30 215 96 255" // Highlight color
	...
	BaseSettings
	{
		...
		Slider.NobColor				"30 215 96 255" // Highlight color
		Slider.TextColor			"243 243 243 255" // Menu text color
		Slider.TrackColor			"243 243 243 255" // Menu text color
		Slider.DisabledTextColor1	"243 243 243 120" // Dimm Menu text color
		Slider.DisabledTextColor2	"243 243 243 120" // Dimm Menu text color
