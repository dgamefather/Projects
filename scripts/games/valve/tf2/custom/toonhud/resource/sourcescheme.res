...
Scheme
{
	Colors
	{
		...
		"G_ActiveWindow"			"24 24 24 255" // Active window bg color
		"G_InctiveWindow"			"24 24 24 230" // Inactive window bg color
		"G_TitleBg"					"156 53 51 0" // Title bg color
		"G_TitleText"				"160 160 160 255" // Title text color
		"G_Highlight"				"30 215 96 255" // Highlight color
		"G_ConsoleBg"				"24 24 24 255" // Console bg color
		"G_ListBg"					"24 24 24 255" // List bg color
		"G_Border"					"40 40 40 255" // Border color
		"G_Text"					"160 160 160 255" // Text color
		"G_HighlightText"			"24 24 24 255" // Highlight text color
		"G_SelectedText"			"255 255 255 255" // Selected text color
		"G_DisabledText"			"160 160 160 128" // Disabled text color
		"G_ButtonBg"				"40 40 40 255" // Button bg color
		"G_ButtonText"				"160 160 160 255" // Button text color
		"G_ButtonHoverBg"			"30 215 96 255" // Button hover bg color
		"G_ButtonHoverText"			"24 24 24 255" // Button hover text color
		"G_InputBg"					"24 24 24 255" // Input bg color
	    ...
	    "QuickListBGSelected"       "30 215 96 255" // Highlight color
